...
struct Exit {
	static constexpr bool is_noreturn = true;
};
...
// int sys_prepare_stack(void **stack, void *entry, void *user_arg, void* tcb, size_t *stack_size,
...
// int sys_vm_map(void *hint, size_t size, int prot, int flags, int fd, off_t offset, void
// **window);
struct VmMap {};
...
// int sys_riscv_hwprobe(struct riscv_hwprobe *pairs, size_t pair_count, size_t cpusetsize,
...
struct GetLoadavg {};
// int sys_openpty(int *mfd, int *sfd, char *name, const struct termios *ios, const struct winsize
// *win);
struct Openpty {};
...
struct MsgSend {};
// int sys_sendto(int fd, const void *buffer, size_t size, int flags, const struct sockaddr
// *sock_addr, socklen_t addr_length, ssize_t *length);
struct Sendto {};
// int sys_msg_recv(int fd, struct msghdr *hdr, int flags, ssize_t *length);
struct MsgRecv {};
// int sys_recvfrom(int fd, void *buffer, size_t size, int flags, struct sockaddr *sock_addr,
...
struct Fexecve {};
// int sys_pselect(int num_fds, fd_set *read_set, fd_set *write_set, fd_set *except_set, const
// struct timespec *timeout, const sigset_t *sigmask, int *num_events);
struct Pselect {};
...
struct Link {};
// int sys_linkat(int olddirfd, const char *old_path, int newdirfd, const char *new_path, int
// flags);
struct Linkat {};
...
struct Poll {};
// int sys_ppoll(struct pollfd *fds, nfds_t count, const struct timespec *ts, const sigset_t *mask,
// int *num_events);
struct Ppoll {};
// int sys_ioctl(int fd, unsigned long request, void *arg, int *result);
struct Ioctl {};
// int sys_posix_devctl(int fd, int dcmd, void *__restrict dev_data_ptr, size_t nbyte, int
// *__restrict dev_info_ptr);
struct PosixDevctl {};
...
// int sys_sigtimedwait(const sigset_t *__restrict set, siginfo_t *__restrict info, const struct
// timespec *__restrict timeout, int *out_signal);
struct Sigtimedwait {};
...
struct Connect {};
// int sys_sockname(int fd, struct sockaddr *addr_ptr, socklen_t max_addr_length, socklen_t
// *actual_length);
struct Sockname {};
// int sys_peername(int fd, struct sockaddr *addr_ptr, socklen_t max_addr_length, socklen_t
// *actual_length);
struct Peername {};
...
struct Waitid {};
// int sys_name_to_handle_at(int dirfd, const char *pathname, struct file_handle *handle, int
// *mount_id, int flags);
struct NameToHandleAt {};
// int sys_splice(int in_fd, off_t *in_off, int out_fd, off_t *out_off, size_t size, unsigned int
// flags, ssize_t *out);
struct Splice {};
...
// int sys_mount(const char *source, const char *target, const char *fstype, unsigned long flags,
// const void *data);
struct Mount {};
...
struct Fstatfs {};
// int sys_statx(int dirfd, const char *pathname, int flags, unsigned int mask, struct statx
// *statxbuf);
struct Statx {};
...
// int sys_process_vm_readv(pid_t pid, const struct iovec *local_iov, unsigned long liovcnt, const
// struct iovec *remote_iov, unsigned long riovcnt, unsigned long flags, ssize_t *out);
struct ProcessVmReadv {};
// int sys_process_vm_writev(pid_t pid, const struct iovec *local_iov, unsigned long liovcnt, const
// struct iovec *remote_iov, unsigned long riovcnt, unsigned long flags, ssize_t *out);
...
struct Fsconfig {};
// int sys_move_mount(int from_dirfd, const char *from_path, int to_dirfd, const char *to_path,
// unsigned int flags);
struct MoveMount {};
// int sys_open_tree(int dirfd, const char *path, unsigned int flags, int *outfd);
struct OpenTree {};
// int sys_copy_file_range(int fd_in, off_t *off_in, int fd_out, off_t *off_out, size_t count,
// unsigned int flags, ssize_t *bytes_copied);
struct CopyFileRange {};
#endif // __MLIBC_LINUX_OPTION

#if __MLIBC_LINUX_EPOLL_OPTION || __MLIBC_WOS_OPTION
#include <sys/epoll.h>
...
struct EpollCtl {};
// int sys_epoll_pwait(int epfd, struct epoll_event *ev, int n, int timeout, const sigset_t
// *sigmask, int *raised);
struct EpollPwait {};
#endif // __MLIBC_LINUX_EPOLL_OPTION || __MLIBC_WOS_OPTION
...
// int sys_timerfd_settime(int fd, int flags, const struct itimerspec *value, struct itimerspec
// *oldvalue);
