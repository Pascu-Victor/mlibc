...
int
pthread_attr_getguardsize(const pthread_attr_t *__restrict __attr, size_t *__restrict __guardsize);
...
int pthread_attr_getschedparam(
    const pthread_attr_t *__restrict __attr, struct sched_param *__restrict __param
);
int pthread_attr_setschedparam(
    pthread_attr_t *__restrict __attr, const struct sched_param *__restrict __param
);

int
pthread_attr_getschedpolicy(const pthread_attr_t *__restrict __attr, int *__restrict __schedpolicy);
int pthread_attr_setschedpolicy(pthread_attr_t *__restrict __attr, int __schedpolicy);

int pthread_attr_getinheritsched(
    const pthread_attr_t *__restrict __attr, int *__restrict __inheritsched
);
int pthread_attr_setinheritsched(pthread_attr_t *__restrict __attr, int __inheritsched);

#if __MLIBC_LINUX_OPTION
int pthread_attr_getaffinity_np(
    const pthread_attr_t *__restrict __attr, size_t __cpusetsize, cpu_set_t *__restrict __cpuset
);
int pthread_attr_setaffinity_np(
    pthread_attr_t *__restrict __attr, size_t __cpusetsize, const cpu_set_t *__restrict __cpuset
);

int
pthread_attr_getsigmask_np(const pthread_attr_t *__restrict __attr, sigset_t *__restrict __sigmask);
int
pthread_attr_setsigmask_np(pthread_attr_t *__restrict __attr, const sigset_t *__restrict __sigmask);
...
int
pthread_mutexattr_getrobust(const pthread_mutexattr_t *__restrict __attr, int *__restrict __robust);
...
int pthread_mutexattr_getprotocol(
    const pthread_mutexattr_t *__restrict __attr, int *__restrict __protocol
);
...
int
pthread_mutex_init(pthread_mutex_t *__restrict __mtx, const pthread_mutexattr_t *__restrict __attr);
...
int pthread_mutex_timedlock(
    pthread_mutex_t *__restrict __mtx, const struct timespec *__restrict __abs_timeout
);
int pthread_mutex_clocklock(
    pthread_mutex_t *__restrict __mtx,
    clockid_t __clockid,
...
int pthread_condattr_getclock(
    const pthread_condattr_t *__restrict __attr, clockid_t *__restrict __clockid
);
...
int
pthread_cond_init(pthread_cond_t *__restrict __cond, const pthread_condattr_t *__restrict __attr);
...
int pthread_barrierattr_getpshared(
    const pthread_barrierattr_t *__restrict __attr, int *__restrict __pshared
);
...
int pthread_rwlockattr_getpshared(
    const pthread_rwlockattr_t *__restrict __attr, int *__restrict __pshared
);

int pthread_rwlock_init(
    pthread_rwlock_t *__restrict __rwlock, const pthread_rwlockattr_t *__restrict __attr
);
int pthread_rwlock_destroy(pthread_rwlock_t *__rwlock);
int pthread_rwlock_trywrlock(pthread_rwlock_t *__rwlock);
int pthread_rwlock_wrlock(pthread_rwlock_t *__rwlock);
int
pthread_rwlock_timedwrlock(pthread_rwlock_t *__rwlock, const struct timespec *__restrict __abstime);
int pthread_rwlock_clockwrlock(
    pthread_rwlock_t *__rwlock, clockid_t __clockid, const struct timespec *__restrict __abstime
);
int pthread_rwlock_tryrdlock(pthread_rwlock_t *__rwlock);
int pthread_rwlock_rdlock(pthread_rwlock_t *__rwlock);
int
pthread_rwlock_timedrdlock(pthread_rwlock_t *__rwlock, const struct timespec *__restrict __abstime);
...
int pthread_rwlockattr_getkind_np(
    const pthread_rwlockattr_t *__restrict __attr, int *__restrict __pref
);
#endif /* __MLIBC_XOPEN */
