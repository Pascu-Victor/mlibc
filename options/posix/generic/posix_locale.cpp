...
void freelocale(locale_t loc) { mlibc::freeLocale(reinterpret_cast<mlibc::localeinfo *>(loc)); }
...
locale_t duplocale(locale_t loc) {
	...
	return frg::construct<mlibc::localeinfo>(
	    getAllocator(), *reinterpret_cast<mlibc::localeinfo *>(loc)
	);
}
